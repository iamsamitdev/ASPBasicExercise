<%@ Page Title="Home" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CustomMasterPages.Default" 
%>
	...
	<div class="container">
		<div id="my-carousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="item">
					<img src="Content/images/slide2.jpg" />
					<div class="carousel-caption">
				...
				<div class="item">
					<img src="Content/images/slide3.jpg" />
					<div class="carousel-caption">
